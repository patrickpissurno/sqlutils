...
describe('groupColumnsToObjects', () => {
  ...
  test('simple case (flat children)', () => {
    const rows = [
    ...
    const expected = [
      {
        ssn: 'abcd',
        name: 'John Doe',
        emails: ['john@example.com', 'john@acme.com'],
      },
      {
        ssn: 'defg',
        name: 'Jimmy',
  ...
  test('simple case (no rename)', () => {
    ...
    assert.deepStrictEqual(found, expected, 'should match');
  });

  test('two groupings at once', () => {
    const rows = [
      {
        ssn: 'abcd',
        name: 'John Doe',
